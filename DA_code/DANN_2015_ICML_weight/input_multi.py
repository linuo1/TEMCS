...
#u, hist_it, hist_follow, hist_vote, target_id, 1
    for t in ts:   #对于每条训练样本
        ...
        domain_label.append([0, 1])

    hist_it = zhuan_2D(sl, list_it)
    hist_follow = zhuan_2D(sl_follow, list_follow)
    hist_vote = zhuan_2D(sl_vote, list_vote)

    return self.i, (u, i, y, hist_it, hist_follow, hist_vote, sl, sl_follow, sl_vote, domain_label, weig)
...
class DataInputTest:
    ...
    def __next__(self):
        ...
        return self.i, (u, i, j, hist_it, hist_follow, hist_vote, sl, sl_follow, sl_vote, domain_label)
