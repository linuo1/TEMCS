...
#u, hist_it, hist_follow, hist_vote, target_id, 1
    ...
    return self.i, (u, i, y, hist_it, hist_follow, hist_vote, sl, sl_follow, sl_vote, weig_f, weig_v)
...
class DataInputTest:
    ...
    def __next__(self):
        ...
        return self.i, (u, i, j, hist_it, hist_follow, hist_vote, sl, sl_follow, sl_vote,weig_f, weig_v)
